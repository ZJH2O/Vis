  ...
  <div class="background-layer">
    ...
    <div class="container">
      ...
      <div class="map-section sentiment-section" ref="sentiment" id="sentiment-analysis">
        ...
        <div class="explanation-block">
          <p class="description-text">
          该视图融合时间维度情绪动态（左侧堆叠图）与时段情绪结构（右侧旭日图），基于社交媒体推文情绪数据构建交互分析体系。左侧堆叠图以时间块为横轴，按 Negative（负向）、Emergency（紧急）、Neutral（中性）、Positive（正向） 顺序堆叠，负向情绪数值取反后向下延伸，正向与中性向上聚合，通过 “正负轴” 直观对比情绪强弱趋势；右侧旭日图通过点击联动触发，中心层以统一标识锚定视觉焦点，主情绪层继承左侧色调映射，子类别层展开细分维度（如正向的希望、感恩，负向的损害、救援等），以层级结构解析情绪内在构成。视觉上，柔和色调体系强化情绪类别识别；技术上，ECharts 的堆叠配置、旭日图层级设计（含中心层交互禁用）及响应式适配，保障多终端呈现一致性。二者协同，既支持宏观追踪舆论情绪的时间波动规律，又允许微观拆解特定时段的情绪细分特征，为舆情洞察提供 “趋势→结构” 的完整分析路径 。 
          </p>
        </div>
      </div>
